...
## Valid Anagram *([Problem](https://leetcode.com/problems/valid-anagram/) | [Solution](../Problems/242.%20Valid%20Anagram/solution.py))*
- **Category:** Array & Hashing
...
## Two Sum *([Problem](https://leetcode.com/problems/two-sum/) | [Solution](../Problems/1.%20Two%20Sum/solution.py))*
- **Category:** Array & Hashing
- **Time Complexity:** O(n)
- **Space Complexity:** O(n)
- **Notes:**
...
## Group Anagrams *([Problem](https://leetcode.com/problems/group-anagrams/) | [Solution](../Problems/49.%20Group%20Anagrams/solution.py))*
- **Category:** Array & Hashing
...
## Top K Frequent Elements *([Problem](https://leetcode.com/problems/top-k-frequent-elements/) | [Solution](../Problems/347.%20Top%20K%20Frequent%20Elements/solution.py))*
- **Category:** Array & Hashing
- **Time Complexity:** O(n)
- **Space Complexity:** O(n)
- **Notes:**
...
## Encode and Decode Strings *([Problem](https://leetcode.com/problems/encode-and-decode-strings/) | [Solution](../Problems/271.%20Encode%20and%20Decode%20Strings/solution.py))*
- **Category:** Array & Hashing
- **Time Complexity:** O(n)
...
## Product of Array Except Self *([Problem](https://leetcode.com/problems/product-of-array-except-self/) | [Solution](../Problems/238.%20Product%20of%20Array%20Except%20Self/solution.py))*
- **Category:** Array & Hashing
- **Time Complexity:** O(n)
...
## Longest Consecutive Sequence *([Problem](https://leetcode.com/problems/longest-consecutive-sequence/) | [Solution](../Problems/128.%20Longest%20Consecutive%20Sequence/solution.py))*
- **Category:** Array & Hashing
- **Time Complexity:** O(n)
- **Space Complexity:** O(n)
- **Notes:**
...
## Valid Palindrome *([Problem](https://leetcode.com/problems/valid-palindrome/) | [Solution](../Problems/125.%20Valid%20Palindrome/solution.py))*
...
## Two Sum II Input Array Is Sorted *([Problem](https://leetcode.com/problems/two-sum-ii-input-array-is-sorted/) | [Solution](../Problems/167.%20Two%20Sum%20II%20Input%20Array%20Is%20Sorted/solution.py))*
- **Category:** Two Pointers
- **Time Complexity:** O(n)
- **Space Complexity:** O(1)
- **Notes:**
...
## Three Sum *([Problem](https://leetcode.com/problems/3sum/) | [Solution](../Problems/15.%20Three%20Sum/solution.py))*
- **Category:** Two Pointers
...
## Container With Most Water *([Problem](https://leetcode.com/problems/container-with-most-water/) | [Solution](../Problems/11.%20Container%20With%20Most%20Water/solution.py))*
- **Category:** Two Pointers
- **Time Complexity:** O(n)
- **Space Complexity:** O(1)
- **Notes:**
...
## Best Time to Buy and Sell Stock *([Problem](https://leetcode.com/problems/best-time-to-buy-and-sell-stock/) | [Solution](../Problems/121.%20Best%20Time%20to%20Buy%20and%20Sell%20Stock/solution.py))*
...
## Longest Substring Without Repeating Characters *([Problem](https://leetcode.com/problems/longest-substring-without-repeating-characters/) | [Solution](../Problems/3.%20Longest%20Substring%20Without%20Repeating%20Characters/solution.py))*
- **Category:** Sliding Window
- **Time Complexity:** O(n)
...
## Longest Repeating Character Replacement *([Problem](https://leetcode.com/problems/longest-repeating-character-replacement/) | [Solution](../Problems/424.%20Longest%20Repeating%20Character%20Replacement/solution.py))*
- **Category:** Sliding Window
- **Time Complexity:** O(n)
- **Space Complexity:** O(m)
- **Notes:**
...
## Minimum Window Substring *([Problem](https://leetcode.com/problems/minimum-window-substring/) | [Solution](../Problems/76.%20Minimum%20Window%20Substring/solution.py))*
- **Category:** Sliding Window
- **Time Complexity:** O(n + m)
- **Space Complexity:** O(m)
- **Notes:**
...
## Valid Parentheses *([Problem](https://leetcode.com/problems/valid-parentheses/) | [Solution](../Problems/20.%20Valid%20Parentheses/solution.py))*
- **Category:** Stack
- **Time Complexity:** O(n)
- **Space Complexity:** O(n)
- **Notes:**
...
## Binary Search *([Problem](https://leetcode.com/problems/binary-search/) | [Solution](../Problems/704.%20Binary%20Search/solution.py))*
...
## Search a 2D Matrix *([Problem](https://leetcode.com/problems/search-a-2d-matrix/) | [Solution](../Problems/74.%20Search%20a%202D%20Matrix/solution.py))*
- **Category:** Binary Search
...
## Koko Eating Bananas *([Problem](https://leetcode.com/problems/koko-eating-bananas/) | [Solution](../Problems/875.%20Koko%20Eating%20Bananas/solution.py))*
- **Category:** Binary Search
- **Time Complexity:** O(lognm)
- **Space Complexity:** O(1)
- **Notes:**
...
## Find Minimum In Rotated Sorted Array *([Problem](https://leetcode.com/problems/find-minimum-in-rotated-sorted-array/) | [Solution](../Problems/153.%20Find%20Minimum%20In%20Rotated%20Sorted%20Array/solution.py))*
- **Category:** Binary Search
...
## Search In Rotated Sorted Array *([Problem](https://leetcode.com/problems/search-in-rotated-sorted-array/) | [Solution](../Problems/33.%20Search%20In%20Rotated%20Sorted%20Array/solution.py))*
- **Category:** Binary Search
- **Time Complexity:** O(log n)
- **Space Complexity:** O(1)
- **Notes:**
...
## Reverse Linked List *([Problem](https://leetcode.com/problems/reverse-linked-list/) | [Solution](../Problems/206.%20Reverse%20Linked%20List/solution.py))*
...
## Merge Two Sorted Lists *([Problem](https://leetcode.com/problems/merge-two-sorted-lists/) | [Solution](../Problems/21.%20Merge%20Two%20Sorted%20Lists/solution.py))*
- **Category:** Linked List
- **Time Complexity:** O(n + m)
- **Space Complexity:** O(1)
- **Notes:**
...
## Linked List Cycle *([Problem](https://leetcode.com/problems/linked-list-cycle/) | [Solution](../Problems/141.%20Linked%20List%20Cycle/solution.py))*
- **Category:** Linked List
- **Time Complexity:** O(n)
- **Space Complexity:** O(1)
- **Notes:**
...
## Reorder List *([Problem](https://leetcode.com/problems/reorder-list/) | [Solution](../Problems/143.%20Reorder%20List/solution.py))*
- **Category:** Linked List
- **Time Complexity:** O(n)
- **Space Complexity:** O(1)
- **Notes:**
...
## Remove Nth Node From End of List *([Problem](https://leetcode.com/problems/remove-nth-node-from-end-of-list/) | [Solution](../Problems/19.%20Remove%20Nth%20Node%20From%20End%20of%20List/solution.py))*
- **Category:** Linked List
- **Time Complexity:** O(n)
- **Space Complexity:** O(1)
- **Notes:**
...
## Merge K Sorted Lists *([Problem](https://leetcode.com/problems/merge-k-sorted-lists/) | [Solution](../Problems/23.%20Merge%20K%20Sorted%20Lists/solution.py))*
- **Category:** Linked List
...
## Invert Binary Tree *([Problem](https://leetcode.com/problems/invert-binary-tree/) | [Solution](../Problems/226.%20Invert%20Binary%20Tree/solution.py))*
- **Category:** Trees
- **Time Complexity:** O(n)
- **Space Complexity:** O(n)
- **Notes:** 1) Edge case, 2) swap left and right nodes, 3) Recursively call on both left and right nodes (the ones we changed)

## Maximum Depth of Binary Tree (DFS) *([Problem](https://leetcode.com/problems/maximum-depth-of-binary-tree/) | [Solution](../Problems/104.%20Maximum%20Depth%20of%20Binary%20Tree%20%28DFS%29/solution.py))*
- **Category:** Trees
- **Time Complexity:** O(n)
...
## Same Tree (DFS) *([Problem](https://leetcode.com/problems/same-tree/) | [Solution](../Problems/100.%20Same%20Tree%20%28DFS%29/solution.py))*
- **Category:** Trees
- **Time Complexity:** O(n)
- **Space Complexity:** O(n)
- **Notes:**
...
## Subtree of Another Tree (DFS) *([Problem](https://leetcode.com/problems/subtree-of-another-tree/) | [Solution](../Problems/572.%20Subtree%20of%20Another%20Tree%20%28DFS%29/solution.py))*
- **Category:** Trees
- **Time Complexity:** O(nm)
- **Space Complexity:** O(n + m)
- **Notes:**
...
## Lowest Common Ancestor of a Binary Search Tree *([Problem](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-search-tree/) | [Solution](../Problems/235.%20Lowest%20Common%20Ancestor%20of%20a%20Binary%20Search%20Tree/solution.py))*
- **Category:** Trees
- **Time Complexity:** O(h)
- **Space Complexity:** O(1)
- **Notes:**
...
## Binary Tree Level Order Traversal *([Problem](https://leetcode.com/problems/binary-tree-level-order-traversal/) | [Solution](../Problems/102.%20Binary%20Tree%20Level%20Order%20Traversal/solution.py))*
- **Category:** Trees
- **Time Complexity:** O(n)
- **Space Complexity:** O(n)

## Validate Binary Search Tree *([Problem](https://leetcode.com/problems/validate-binary-search-tree/) | [Solution](../Problems/98.%20Validate%20Binary%20Search%20Tree/solution.py))*
- **Category:** Trees
- **Time Complexity:** O(n)

## Kth Smallest Element In a Bst *([Problem](https://leetcode.com/problems/kth-smallest-element-in-a-bst/) | [Solution](../Problems/230.%20Kth%20Smallest%20Element%20In%20a%20Bst/solution.py))*
- **Category:** Trees

## Construct Binary Tree From Preorder And Inorder Traversal *([Problem](https://leetcode.com/problems/construct-binary-tree-from-preorder-and-inorder-traversal/) | [Solution](../Problems/105.%20Construct%20Binary%20Tree%20From%20Preorder%20And%20Inorder%20Traversal/solution.py))*
- **Category:** Trees

## Binary Tree Maximum Path Sum *([Problem](https://leetcode.com/problems/binary-tree-maximum-path-sum/) | [Solution](../Problems/124.%20Binary%20Tree%20Maximum%20Path%20Sum/solution.py))*
- **Category:** Trees
