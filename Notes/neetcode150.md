...
**Contains Duplicate** *([Problem](https://leetcode.com/problems/contains-duplicate/) | [Solution](../Problems/NeetCode150/0217.%20Contains%20Duplicate/solution.py))*
- **Time Complexity:** O(n)
- **Space Complexity:** O(n)
- **Notes:** Hashset, check if the value is in seen otherwise, add it to seen

**Valid Anagram** *([Problem](https://leetcode.com/problems/valid-anagram/) | [Solution](../Problems/NeetCode150/0242.%20Valid%20Anagram/solution.py))*
...
**Two Sum** *([Problem](https://leetcode.com/problems/two-sum/) | [Solution](../Problems/NeetCode150/0001.%20Two%20Sum/solution.py))*
- **Time Complexity:** O(n)
- **Space Complexity:** O(n)
- **Notes:**
...
**Group Anagrams** *([Problem](https://leetcode.com/problems/group-anagrams/) | [Solution](../Problems/NeetCode150/0049.%20Group%20Anagrams/solution.py))*
...
**Top K Frequent Elements** *([Problem](https://leetcode.com/problems/top-k-frequent-elements/) | [Solution](../Problems/NeetCode150/0347.%20Top%20K%20Frequent%20Elements/solution.py))*
- **Time Complexity:** O(n)
- **Space Complexity:** O(n)
- **Notes:**
...
**Encode and Decode Strings** *([Problem](https://leetcode.com/problems/encode-and-decode-strings/) | [Solution](../Problems/NeetCode150/0271.%20Encode%20and%20Decode%20Strings/solution.py))*
- **Time Complexity:** O(n)
...
**Product of Array Except Self** *([Problem](https://leetcode.com/problems/product-of-array-except-self/) | [Solution](../Problems/NeetCode150/0238.%20Product%20of%20Array%20Except%20Self/solution.py))*
- **Time Complexity:** O(n)
...
**Longest Consecutive Sequence** *([Problem](https://leetcode.com/problems/longest-consecutive-sequence/) | [Solution](../Problems/NeetCode150/0128.%20Longest%20Consecutive%20Sequence/solution.py))*
- **Time Complexity:** O(n)
- **Space Complexity:** O(n)
- **Notes:**
...
**Valid Palindrome** *([Problem](https://leetcode.com/problems/valid-palindrome/) | [Solution](../Problems/NeetCode150/0125.%20Valid%20Palindrome/solution.py))*
- **Time Complexity:** O(n)
- **Space Complexity:** O(1)
- **Notes:**
...
**Two Sum II Input Array Is Sorted** *([Problem](https://leetcode.com/problems/two-sum-ii-input-array-is-sorted/) | [Solution](../Problems/NeetCode150/0167.%20Two%20Sum%20II%20Input%20Array%20Is%20Sorted/solution.py))*
- **Time Complexity:** O(n)
- **Space Complexity:** O(1)
- **Notes:**
  - Loop 2 pointers
...
**Three Sum** *([Problem](https://leetcode.com/problems/3sum/) | [Solution](../Problems/NeetCode150/0015.%20Three%20Sum/solution.py))*
...
**Container With Most Water** *([Problem](https://leetcode.com/problems/container-with-most-water/) | [Solution](../Problems/NeetCode150/0011.%20Container%20With%20Most%20Water/solution.py))*
- **Time Complexity:** O(n)
- **Space Complexity:** O(1)
- **Notes:**
  - Two pointers
...
**Best Time to Buy and Sell Stock** *([Problem](https://leetcode.com/problems/best-time-to-buy-and-sell-stock/) | [Solution](../Problems/NeetCode150/0121.%20Best%20Time%20to%20Buy%20and%20Sell%20Stock/solution.py))*
- **Time Complexity:** O(n)
- **Space Complexity:** O(1)
- **Notes:**
  - Two pointers
...
**Longest Substring Without Repeating Characters** *([Problem](https://leetcode.com/problems/longest-substring-without-repeating-characters/) | [Solution](../Problems/NeetCode150/0003.%20Longest%20Substring%20Without%20Repeating%20Characters/solution.py))*
- **Time Complexity:** O(n)
...
**Longest Repeating Character Replacement** *([Problem](https://leetcode.com/problems/longest-repeating-character-replacement/) | [Solution](../Problems/NeetCode150/0424.%20Longest%20Repeating%20Character%20Replacement/solution.py))*
- **Time Complexity:** O(n)
- **Space Complexity:** O(m)
- **Notes:**
...
**Minimum Window Substring** *([Problem](https://leetcode.com/problems/minimum-window-substring/) | [Solution](../Problems/NeetCode150/0076.%20Minimum%20Window%20Substring/solution.py))*
- **Time Complexity:** O(n + m)
- **Space Complexity:** O(m)
- **Notes:**
...
**Valid Parentheses** *([Problem](https://leetcode.com/problems/valid-parentheses/) | [Solution](../Problems/NeetCode150/0020.%20Valid%20Parentheses/solution.py))*
- **Time Complexity:** O(n)
- **Space Complexity:** O(n)
- **Notes:**
...
**Binary Search** *([Problem](https://leetcode.com/problems/binary-search/) | [Solution](../Problems/NeetCode150/0704.%20Binary%20Search/solution.py))*
...
**Search a 2D Matrix** *([Problem](https://leetcode.com/problems/search-a-2d-matrix/) | [Solution](../Problems/NeetCode150/0074.%20Search%20a%202D%20Matrix/solution.py))*
...
**Koko Eating Bananas** *([Problem](https://leetcode.com/problems/koko-eating-bananas/) | [Solution](../Problems/NeetCode150/0875.%20Koko%20Eating%20Bananas/solution.py))*
- **Time Complexity:** O(lognm)
- **Space Complexity:** O(1)
- **Notes:**
...
**Find Minimum In Rotated Sorted Array** *([Problem](https://leetcode.com/problems/find-minimum-in-rotated-sorted-array/) | [Solution](../Problems/NeetCode150/0153.%20Find%20Minimum%20In%20Rotated%20Sorted%20Array/solution.py))*
...
**Search In Rotated Sorted Array** *([Problem](https://leetcode.com/problems/search-in-rotated-sorted-array/) | [Solution](../Problems/NeetCode150/0033.%20Search%20In%20Rotated%20Sorted%20Array/solution.py))*
- **Time Complexity:** O(log n)
- **Space Complexity:** O(1)
- **Notes:**
  - Two pointers and loop until they cross, it's okay if they're equal
...
**Reverse Linked List** *([Problem](https://leetcode.com/problems/reverse-linked-list/) | [Solution](../Problems/NeetCode150/0206.%20Reverse%20Linked%20List/solution.py))*
- **Time Complexity:** O(n)
- **Space Complexity:** O(1)
- **Notes:**
...
**Merge Two Sorted Lists** *([Problem](https://leetcode.com/problems/merge-two-sorted-lists/) | [Solution](../Problems/NeetCode150/0021.%20Merge%20Two%20Sorted%20Lists/solution.py))*
- **Time Complexity:** O(n + m)
- **Space Complexity:** O(1)
- **Notes:**
...
**Linked List Cycle** *([Problem](https://leetcode.com/problems/linked-list-cycle/) | [Solution](../Problems/NeetCode150/0141.%20Linked%20List%20Cycle/solution.py))*
- **Time Complexity:** O(n)
- **Space Complexity:** O(1)
- **Notes:**
  - Slow/fast pointers
...
**Reorder List** *([Problem](https://leetcode.com/problems/reorder-list/) | [Solution](../Problems/NeetCode150/0143.%20Reorder%20List/solution.py))*
- **Time Complexity:** O(n)
- **Space Complexity:** O(1)
- **Notes:**
...
**Remove Nth Node From End of List** *([Problem](https://leetcode.com/problems/remove-nth-node-from-end-of-list/) | [Solution](../Problems/NeetCode150/0019.%20Remove%20Nth%20Node%20From%20End%20of%20List/solution.py))*
- **Time Complexity:** O(n)
- **Space Complexity:** O(1)
- **Notes:**
...
**Merge K Sorted Lists** *([Problem](https://leetcode.com/problems/merge-k-sorted-lists/) | [Solution](../Problems/NeetCode150/0023.%20Merge%20K%20Sorted%20Lists/solution.py))*
...
**Invert Binary Tree** *([Problem](https://leetcode.com/problems/invert-binary-tree/) | [Solution](../Problems/NeetCode150/0226.%20Invert%20Binary%20Tree/solution.py))*
- **Time Complexity:** O(n)
- **Space Complexity:** O(n)
- **Notes:** 1) Edge case, 2) swap left and right nodes, 3) Recursively call on both left and right nodes (the ones we changed)

**Maximum Depth of Binary Tree (DFS)** *([Problem](https://leetcode.com/problems/maximum-depth-of-binary-tree/) | [Solution](../Problems/NeetCode150/0104.%20Maximum%20Depth%20of%20Binary%20Tree%20%28DFS%29/solution.py))*
- **Time Complexity:** O(n)
...
**Same Tree (DFS)** *([Problem](https://leetcode.com/problems/same-tree/) | [Solution](../Problems/NeetCode150/0100.%20Same%20Tree%20%28DFS%29/solution.py))*
- **Time Complexity:** O(n)
- **Space Complexity:** O(n)
- **Notes:**
...
**Subtree of Another Tree (DFS)** *([Problem](https://leetcode.com/problems/subtree-of-another-tree/) | [Solution](../Problems/NeetCode150/0572.%20Subtree%20of%20Another%20Tree%20%28DFS%29/solution.py))*
- **Time Complexity:** O(nm)
- **Space Complexity:** O(n + m)
- **Notes:**
...
**Lowest Common Ancestor of a Binary Search Tree** *([Problem](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-search-tree/) | [Solution](../Problems/NeetCode150/0235.%20Lowest%20Common%20Ancestor%20of%20a%20Binary%20Search%20Tree/solution.py))*
- **Time Complexity:** O(h)
- **Space Complexity:** O(1)
- **Notes:**
...
**Binary Tree Level Order Traversal** *([Problem](https://leetcode.com/problems/binary-tree-level-order-traversal/) | [Solution](../Problems/NeetCode150/0102.%20Binary%20Tree%20Level%20Order%20Traversal/solution.py))*
- **Time Complexity:** O(n)
- **Space Complexity:** O(n)

**Validate Binary Search Tree** *([Problem](https://leetcode.com/problems/validate-binary-search-tree/) | [Solution](../Problems/NeetCode150/0098.%20Validate%20Binary%20Search%20Tree/solution.py))*
- **Time Complexity:** O(n)

**Kth Smallest Element In a Bst** *([Problem](https://leetcode.com/problems/kth-smallest-element-in-a-bst/) | [Solution](../Problems/NeetCode150/0230.%20Kth%20Smallest%20Element%20In%20a%20Bst/solution.py))*
- _No details provided._

**Construct Binary Tree From Preorder And Inorder Traversal** *([Problem](https://leetcode.com/problems/construct-binary-tree-from-preorder-and-inorder-traversal/) | [Solution](../Problems/NeetCode150/0105.%20Construct%20Binary%20Tree%20From%20Preorder%20And%20Inorder%20Traversal/solution.py))*
- _No details provided._

**Binary Tree Maximum Path Sum** *([Problem](https://leetcode.com/problems/binary-tree-maximum-path-sum/) | [Solution](../Problems/NeetCode150/0124.%20Binary%20Tree%20Maximum%20Path%20Sum/solution.py))*
- _No details provided._

**Serialize And Deserialize Binary Tree** *([Problem](https://leetcode.com/problems/serialize-and-deserialize-binary-tree/) | [Solution](../Problems/NeetCode150/0297.%20Serialize%20And%20Deserialize%20Binary%20Tree/solution.py))*
- _No details provided._

## Uncategorized

**Find Median From Data Stream** *([Problem](https://leetcode.com/problems/find-median-from-data-stream/) | [Solution](../Problems/NeetCode150/0295.%20Find%20Median%20From%20Data%20Stream/solution.py))*
- _No details provided._

**Combination Sum** *([Problem](https://leetcode.com/problems/combination-sum/) | [Solution](../Problems/NeetCode150/0039.%20Combination%20Sum/solution.py))*
- _No details provided._